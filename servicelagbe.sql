...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2022 at 07:29 AM
...
INSERT INTO `approvedserviceproviders` (`approvedproviderid`, `username`, `servicetype`, `availability`, `rating`, `email`, `phone`, `address`, `password`, `dt`) VALUES
(41, 'providerTest', 'Ac Service', 1, 4.5, 'providertest@gmail.com', '12313123124', 'dhaka', '$2y$10$rYBM4AjLmrIJ34Ou7aZUVuSS6Vkki2ZOEK36vWRJoM3YH3Fh/Bdj.', '2022-10-19 11:56:41'),
(42, 'ProviderTahlil', 'Car Care', 1, 4.5, 'tahlilkfaiyaz@gmail.com', '12313123124', 'dhaka', '$2y$10$dcRtf5LB0ai28R8o4U5SL.9BTqmHkhVsWdWojC2FYxX8VPf1G1Pme', '2022-10-19 12:33:23'),
(44, 'ProviderTahlil', 'Ac Service', 1, 4.5, 'p@gmail.com', '12313123124', 'dhaka', '$2y$10$3ksqMoakl..TPAhNvEqrG.VgE0DJk/XGJUwCh8OvZp9mlVrhnYQCS', '2022-10-19 14:48:54');
...
INSERT INTO `userprovider` (`orderid`, `userid`, `useraddress`, `userlocation`, `providerid`, `userphone`, `providerusername`, `provideremail`, `providerphone`, `provideraddress`, `servicetype`, `servicecost`, `appointstatus`, `token`, `dt`) VALUES
(17, 15, '', 'pqrs', 44, '01782633834', 'ProviderTahlil', 'p@gmail.com', '12313123124', 'dhaka', 'Ac Service', 2000, 1, '', '2022-11-05 01:07:58');

...
<!--                    <div class="form-group"><a class="btn btn-light action-button" role="button" href="#">Search&nbsp;</a></div>-->
    ...
    <div class="register-photo">
        <div class="form-container">
            <form action="Signup%20For%20ServiceProvider.php" method="post" style="height: 600;">
...
<!--                <a class="already" href="./Login%20Options.php">You already have an account? Login here.</a>-->
            </form>
        </div>
    </div>

...
<!--                    <div class="form-group"><a class="btn btn-light action-button" role="button" href="#">Search&nbsp;</a></div>-->
            ...
            </div><span class="actions"> <a class="btn btn-light action-button" role="button" href="./Login%20Options.php">Log In</a>  <a class="btn btn-light action-button" role="button" href="./Signup%20Options.php">Sign Up</a></span></div>
    </nav>
    <h3 class="text-center"><br>All Services<br><br></h3>
            ...
            <tbody>
                    ...
                    if(mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>BDT <?php echo $row['servicecost'] ?></td>
                            </tr>
                            <?php
                        }
                    }

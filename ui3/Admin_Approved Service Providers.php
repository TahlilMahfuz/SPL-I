...
<!--                    <div class="form-group"><a class="btn btn-light action-button" role="button" href="#">Search&nbsp;</a></div>-->
    ...
    <h3 class="text-center"><br>Approved Service Providers<br><br></h3>
    <?php
    ...
    if(isset($_SESSION['deletedapprovedprovidererror']) && $_SESSION['deletedapprovedprovidererror']!=''){
        echo '<h5 class="text-center">'.$_SESSION['deletedapprovedprovidererror'].'</h5>';
            ...
            <tbody>
                ...
                if(mysqli_num_rows($query_run) > 0)
                {
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="./Admin_Approved%20Service%20Providers.php" method="post">

...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $adminmasterkey = $_POST["masterkey"];
    ...
    if ($num == 1 && $adminmasterkey=='1234'){
        while($row=mysqli_fetch_assoc($result)){
            if (password_verify($adminpassword, $row['password'])){
                ...
                header("location: Post Administrator Login.php");
            }
            else{
                $showError = "Pass doesnt match.";
            }
        }
    }
    else{
        $showError = "Invalid id or masterkey.";
    }
}
...
<!--                    <div class="form-group"><a class="btn btn-light action-button" role="button" href="#">Search&nbsp;</a></div>-->
    ...
    <div class="login-clean">
        <form action="./Login%20For%20Administrator.php" method="post">
            ...
            <?php
                ...
                if($showError){
                    echo '<h5 class="text-center">Error! '.$showError.'</h5>';
                }
            ?>
            <h4 class="text-center"></h4>
            <div class="form-group"><input class="form-control" type="password" name="masterkey" placeholder="Masterkey"></div>
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email"></div>
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password"></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(102, 215, 215);">Log In</button></div>

...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $admincpassword = $_POST["password-repeat"];
    $adminsignupmasterkey = $_POST["masterkey"];
    // $exists=false;
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" style="height: 600;">
                ...
                <?php
                if($showAlert){
                    echo '<h4 class="text-center">Success! Your account is now created and you can log in.</h4><br>';
                }
                ?>
                <?php
                if($showError){
                    echo '<h4 class="text-center">Error! '.$showError.'</h4><br>';
                }
                ?>

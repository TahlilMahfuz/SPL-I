...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="mx-2">
                <a class="btn btn-success" href="/servicelagbe/loginsystem/login.php"><h7>Login</h7></a> 
                <a class="btn btn-success" href="/servicelagbe/loginsystem/signup.php"><h7>SignUp</h7></a>
            </div>
        </div>
    </nav>
'

    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" style="height: 600;">
                ...
                <div class="form-check"><label class="form-check-label"><input class="form-check-input" type="checkbox">I agree to the license terms.</label></div><button class="btn btn-primary btn-block" type="submit" style="background-color: rgb(102,215,215);">Sign Up</button>
                <a
